  ...
  return (
    <Link href={href} className={styles["blog-hero-article"]}>
      ...
      <div className={styles["blog-hero-article__content"]}>
        <span suppressHydrationWarning className={styles["blog-hero-article__category"]}>
          {category}
        </span>
        <h3 suppressHydrationWarning className={styles["blog-hero-article__title"]}>
          {title}
        </h3>
        <div className={styles["blog-hero-article__author"]}>
          ...
          <span suppressHydrationWarning className={styles["blog-hero-article__author-name"]}>
            {authorName}
          </span>
        </div>
      </div>
