...
export const icons: Record<string, IconRenderer> = {
  ...
  growth: ({ trackRef, dotRef }) => (
    <svg width="125" height="126" viewBox="0 0 125 126" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ref={trackRef}
        d="M93.7535 35C92.4735 35.13 65.9035 65.51 64.4535 62.09C64.0035 61.88 53.5235 50.53 53.0335 51.32C52.6135 51.32 52.2235 51.49 51.9235 51.78L31.1035 72.6"
        stroke="#1E2221"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        ref={dotRef}
        d="M86.6835 38.0001C91.8735 37.9201 91.8735 46.0801 86.6835 46.0001C81.4935 46.0801 81.4935 37.9201 86.6835 38.0001Z"
        fill="#00D180"
        stroke="#1E2221"
        strokeWidth="3"
      />
