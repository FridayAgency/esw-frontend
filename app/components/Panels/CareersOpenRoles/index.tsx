        ...
        <div className="careers-open-roles-list">
          ...
          {itemsFormatted.map((item) => (
            <div key={item.id} className={styles["careers-open-roles-list__item"]}>
              ...
              <div className={styles["careers-open-roles-list__item-location"]}>
                <Icon type="location" />
                {item.location}
              </div>
              <div className={styles["careers-open-roles-list__item-department"]}>
                <Icon type="target" />
                {item.department}
              </div>
              <div className={styles["careers-open-roles-list__item-updated_at"]}>
                <Icon type="clock" />
                {calculateDifferenceInDays(new Date(item.updated_at))} DAYS AGO
              </div>
            </div>
          ))}
        </div>
